...
import com.jimmy.datasource.repositories.playback.PlaybackStore
...
class UpdatePlayback @Inject constructor(
    private val playbackStore: PlaybackStore,
    private val playbackDao: PlaybackEntryDao,
    private val dispatchers: AppCoroutineDispatchers,
    private val logger: Logger,
) : Interactor<UpdatePlayback.Params>() {
        ...
        withContext(dispatchers.io) {
            val page = when {
                ...
                params.page == Page.NEXT_PAGE -> {
                    val lastPage = playbackDao.getLastPage()
            ...
            playbackStore.fetch(page to params.paramsConfig,  forceFresh = params.forceRefresh)
        }
    }
