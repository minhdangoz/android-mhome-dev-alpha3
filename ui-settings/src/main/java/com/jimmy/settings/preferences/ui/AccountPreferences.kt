...
import com.jimmy.settings.preferences.PreferenceCategory
...
fun NavGraphBuilder.accountGraph(route: String) {
    preferenceGraph(route, { AccountPreferences() }) { subRoute ->
    }
}
...
fun AccountPreferences() {
    ...
    PreferenceLayout(label = stringResource(id = R.string.settings_account)) {
