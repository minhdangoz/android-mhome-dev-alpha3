...
fun Modifier.halfBodyWidth() = fillMaxWidth()
    .wrapContentHeight(align = Alignment.CenterVertically)
    .wrapContentWidth(align = Alignment.CenterHorizontally)
    .composed {

        val halfBodyWidth = LocalConfiguration.current.screenWidthDp / 1.8
        heightIn(max = halfBodyWidth.dp)

        widthIn(max = halfBodyWidth.dp)
