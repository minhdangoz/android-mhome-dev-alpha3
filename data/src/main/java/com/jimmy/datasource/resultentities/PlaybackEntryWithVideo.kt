...
class PlaybackEntryWithVideo : EntryWithVideo<PlaybackEntry> {
    @Embedded
    override lateinit var entry: PlaybackEntry

    @Relation(parentColumn = "show_id", entityColumn = "aid")
    override lateinit var relations: List<PlaybackEntity>


    override fun equals(other: Any?): Boolean = when {
        other === this -> true
        other is PlaybackEntryWithVideo -> {
